...
<div>
<iframe src="https://editor.raspberrypi.org/uk-UA/embed/viewer/top-5-emoji-list-step-2" width="500" height="400" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
</div>
</div>

--- task ---

Відкрий [початковий проєкт](https://editor.raspberrypi.org/uk-UA/projects/top-5-emoji-list-starter){:target="_blank"}.
...
Зверни увагу, що класи CSS для стилізації заголовка вже додано. Вони встановлюють вторинні кольори та нижню межу, як у проєкті [Вирази обличчя аніме](https://projects.raspberrypi.org/uk-UA/projects/anime-expressions){:target="_blank"}.
...
<iframe src="https://editor.raspberrypi.org/uk-UA/embed/viewer/top-5-emoji-list-step-2" width="600" height="600" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
